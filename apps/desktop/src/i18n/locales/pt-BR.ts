...
export default withEnglishFallback({
  ...
  settings: {
    ...
    dataGridKeepFilterEditorExpanded: "Expandir editor de filtros por padrão",
    dataGridKeepFilterEditorExpandedDescription: "Abre inicialmente o editor nas visualizações Condições e Texto; ainda é possível recolhê-lo manualmente.",
