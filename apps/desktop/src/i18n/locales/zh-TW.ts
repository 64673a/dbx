...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttCollapsePayload: "收合訊息內容",
    mqttExpandPayload: "展開訊息內容",
  ...
  settings: {
    ...
    dataGridKeepFilterEditorExpanded: "預設展開篩選編輯器",
    dataGridKeepFilterEditorExpandedDescription: "在條件檢視和文字檢視中初始展開編輯器；仍可手動收合。",
